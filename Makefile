...
dev-arm1:
	...
	cmake -B "$(DEV_ARM1)" \
		-DCMAKE_BUILD_TYPE=Debug \
		-DCMAKE_BUILD_PLATFORM=arm1 \
		-DOPENSSL_ROOT_DIR=/opt/homebrew/opt/openssl@3 \
		-DOPENSSL_LIBRARIES=/opt/homebrew/opt/openssl@3/lib
	cmake --build $(DEV_ARM1)
...
dev-arm:
	...
	cmake -B "$(DEV_ARM)" \
		...
		-DCMAKE_C_COMPILER=/opt/homebrew/bin/arm-linux-gnueabihf-gcc \
		-DCMAKE_CXX_COMPILER=/opt/homebrew/bin/arm-linux-gnueabihf-g++ \
